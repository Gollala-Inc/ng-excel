...
class ExcelCell {
    ...
    getCellStyle() {
        ...
        const result = {};
        if (style) {
            if ((_a = style.font) === null || _a === void 0 ? void 0 : _a.size) {
                result['font-size'] = `${style.font.size}px`;
            }
            if ((_b = style.font) === null || _b === void 0 ? void 0 : _b.bold) {
                result['font-weight'] = 'bold';
            }
            if ((_d = (_c = style.font) === null || _c === void 0 ? void 0 : _c.color) === null || _d === void 0 ? void 0 : _d.argb) {
            ...
            if (((_f = (_e = style.fill) === null || _e === void 0 ? void 0 : _e.color) === null || _f === void 0 ? void 0 : _f.indexed) < 64) {
                const index = (((_h = (_g = style.fill) === null || _g === void 0 ? void 0 : _g.color) === null || _h === void 0 ? void 0 : _h.indexed) || 0).toString();
                result['background'] = indexcedColors[index];
            }
            if ((_k = (_j = style.fill) === null || _j === void 0 ? void 0 : _j.fgColor) === null || _k === void 0 ? void 0 : _k.argb) {
                result['background'] = `#${style.fill.fgColor.argb.slice(-6)}`;
            }
            if ((_m = (_l = style.fill) === null || _l === void 0 ? void 0 : _l.fgColor) === null || _m === void 0 ? void 0 : _m.theme) {
...
class ExcelSheet {
    ...
    getImages() {
        ...
        this.sheet.getImages().forEach(img => {
            ...
            images.push(Object.assign({ col1: (_a = img.range.tl) === null || _a === void 0 ? void 0 : _a.nativeCol, col2: (_b = img.range.br) === null || _b === void 0 ? void 0 : _b.nativeCol, colOff1: (_c = img.range.tl) === null || _c === void 0 ? void 0 : _c.nativeColOff, colOff2: (_d = img.range.br) === null || _d === void 0 ? void 0 : _d.nativeColOff, row1: (_e = img.range.tl) === null || _e === void 0 ? void 0 : _e.nativeRow, row2: (_f = img.range.br) === null || _f === void 0 ? void 0 : _f.nativeRow, rowOff1: (_g = img.range.tl) === null || _g === void 0 ? void 0 : _g.nativeRowOff, rowOff2: (_h = img.range.br) === null || _h === void 0 ? void 0 : _h.nativeRowOff, image: this.getImage(+img.imageId), ext: img.range.ext }, position));
        });
        this.images = images;
    }
    getImagePosition(range) {
        ...
        for (let i = 0; i < range.tl.nativeCol; i++) {
            if (!((_a = this.sheet.getColumn(i + 1)) === null || _a === void 0 ? void 0 : _a.hidden)) {
                result.x += (((_b = this.sheet.getColumn(i + 1)) === null || _b === void 0 ? void 0 : _b.width) || 8.34) * 8;
        ...
        for (let i = 0; i < range.tl.nativeRow; i++) {
            if (!((_c = this.sheet.getRow(i + 1)) === null || _c === void 0 ? void 0 : _c.hidden)) {
        ...
        if (range.ext) {
            ...
            for (let i = range.tl.nativeCol; i < range.br.nativeCol; i++) {
                result.width += (((_d = this.sheet.getColumn(i + 1)) === null || _d === void 0 ? void 0 : _d.width) || 8.34) * 8;
            }
